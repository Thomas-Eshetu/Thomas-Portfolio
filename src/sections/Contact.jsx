...
const contactInfo = [
    {
        icon: Mail,
        label: "Email",
        value: "thomaseshetu19@gmail.com",
        href: "mailto:thomaseshetu19@gmail.com",
    },
    {
        icon: Phone,
        label: "Phone",
        value: "+251-942-781-874",
        href: "tel: +251942781874",
    },
    {
        icon: MapPin,
        label: "Location",
        ...
        <section id="contact" className="py-32 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <span className="text-secondary-foreground tet-sm font-medium tracking-wider">
                        Get In Touch
                    </span>
                    ...
                    <div className="space-y-6 animate-fade-in animation-delay-400">
                        ...
                        <div className="glass rounded-3xl p-8 border border-primary/30">
                            ...
                            <p className="text-muted-foreground text-sm">
                                I'm currently available to new opportunities and exciting projects.
                                Wheter you need a full-time engineer or a freelance consultant,
                                let's talk!
                            </p>
                        </div>
                    </div>
